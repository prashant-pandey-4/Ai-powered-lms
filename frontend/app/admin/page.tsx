    ...
    <div className="flex min-h-screen flex-col bg-app bg-grid-pattern">
      ...
      <div className="p-6 lg:p-10 space-y-8 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          <div className="rounded-2xl border border-app bg-card p-5 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-sm font-black text-app">Full Access</h4>
            </div>
            <p className="text-xs font-bold text-muted mt-1">Super Admin Role</p>
          </div>
        </div>

        {/* Quick Studio Actions */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="rounded-3xl border border-app bg-card p-6 flex flex-col justify-between hover:border-[#f97316]/40 transition-colors">
            <div>
              <div className="flex items-center gap-2 text-[#f97316]">
                <BookOpen className="h-5 w-5" />
                <h3 className="text-sm sm:text-base font-bold text-app">Course & Playlist Studio</h3>
              </div>
          ...
          <div className="rounded-3xl border border-app bg-card p-6 flex flex-col justify-between hover:border-[#38bdf8]/40 transition-colors">
            <div>
              <div className="flex items-center gap-2 text-[#38bdf8]">
                <BookOpen className="h-5 w-5" />
                <h3 className="text-sm sm:text-base font-bold text-app">Knowledge Hub Articles</h3>
              </div>
              <p className="text-xs text-muted mt-2 leading-relaxed">
        ...
        <div className="flex items-center justify-between pt-2">
          <h2 className="text-lg font-black text-app">Course Management</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-app p-16 text-center bg-card">
            ...
            <h3 className="text-base font-bold text-app">No courses created yet</h3>
          ...
          <div className="space-y-3">
            {courses.map((c) => (
              <div
                key={c.id}
                className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl border border-app bg-card p-4 transition-colors hover:border-[#f97316]/40"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h4 className="text-sm font-bold text-app">{c.title}</h4>
                      <span
