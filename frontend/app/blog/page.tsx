  ...
  return (
    <div className="flex min-h-screen flex-col bg-app bg-grid-pattern">
      ...
      <div className="p-6 lg:p-10 space-y-8 max-w-7xl mx-auto w-full">
        {/* Hero Section */}
        <div className="rounded-3xl border border-app bg-card p-8 lg:p-10 shadow-2xl space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-app leading-tight">
        ...
        {!loading && filteredBlogs.length === 0 && (
          <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-app p-16 text-center bg-card">
            ...
            <h3 className="text-base font-bold text-app">No articles published yet</h3>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {filteredBlogs.map((post) => (
              <Link
                key={post.id}
                href={`/blog/${post.slug}`}
                className="group flex flex-col overflow-hidden rounded-2xl border border-app bg-card p-4 transition-all duration-300 hover:-translate-y-1 hover:border-[#f97316]/50 shadow-xl"
              >
                {/* Cover Image */}
                <div className="relative aspect-[16/10] w-full overflow-hidden rounded-xl bg-black border border-app">
                  {post.coverImage ? (
                    <img
                      src={post.coverImage}
                      alt={post.title}
                ...
                <div className="flex flex-1 flex-col pt-4">
                  ...
                  <h3 className="text-base font-bold text-app group-hover:text-[#f97316] line-clamp-2 transition-colors">
                    {post.title}
                  </h3>
                  ...
                  <div className="mt-auto pt-4 flex items-center justify-between border-t border-app mt-4">
